...
- [The COVID-19 Canada Open Data Working Groups dashboard](https://art-bd.shinyapps.io/covid19canada/) developed by [Jean-Paul R. Soucy](https://twitter.com/JPSoucy) and [Isha Berry](https://twitter.com/ishaberry2), two amazing talented students from DLSPH, Univerity of Toronto.
...
- [The Ontario-specific COVID-19 Analysis Website](https://howsmyflattening.ca/#/analysis) which covers detailed Ontario focused information on critical care analysis, health region analysis and testing analysis. This website was also built by a group of University of Toronto students.
...
**Acknowledgement**
 ...
 - **Data** 
    - Canada data used in this dashboard are extracted from the data speardsheet posted by the COVID-19 Canada Open Data Working Group (https://github.com/ishaberry/Covid19Canada) lead by [Jean-Paul R. Soucy](https://twitter.com/JPSoucy) and [Isha Berry](https://twitter.com/ishaberry2). Since April 1st, 2020, the working group collected and reported case and mortality data directly from Public Health Units. Therefore, the case and mortality numbers report from the working group may be higher than those from other sources, incuding the Ontario Ministry of Health. We direct reader to their dashboard website, [About the data section](https://art-bd.shinyapps.io/covid19canada/) for details.
...
For those who are interested to learn more about the **COVID-19 Testing trending in Canada**, please see my other project website at <https://rpubs.com/kuanstat/testing_can>, a joint work with [Alexandra Bushby](https://www.linkedin.com/in/alexandra-bushby-571b65168/) and [Thai-Son Tang](https://www.linkedin.com/in/thaison-tang/). 


**Message**

**With a budget shinyapps.io membership, there is a restriction on the number of hours our dashboard can stay active without going over the current allowance. Please help us stay within our plan by closing the dashboard webpage once you have completed the viewing. If you would like to get in touch about hosting the dash at your webpage with shiny server or Rstudio connect, please get in touch with us.**
