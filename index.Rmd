...
```{r}
# Map #I have trouble deploying maps, it shows on my Rstudio document but failed everytime I try deploying it to shinyapps. Will try latter midnight, when no one is access the app.
# =======================================================================
# 
...
# 
# renderLeaflet({leaflet(canada_map_region) %>% 
#   addTiles() %>% 
