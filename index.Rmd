...
# on_case_tt<- melt(on_case_t, id.vars=c("date_report"), variable.name = "Region",row.names())
# on_case_tt %>% pivot_longer(-date_report, names_to="Region", values_to = "Cases")
...
trt[,1:5] %>% 
  DT::datatable(rownames = FALSE,
                colnames = c("Date","Daily Cases","Daily Death", "Cumulative Cases", "Cumulative Death"), options = list(searching = FALSE), filter = 'none')
...
About
=======================================================================
**Last Updated:** `r format(Sys.time(), "%b %d, %Y %X EDT")`
