...
```{r }
qc_case_tt2<-filter(qc_case_tt, date_report>as.Date("2020-02-29") & qc_case_tt$Region !="Not Reported")
plot_ly(qc_case_tt, x=~date_report, y=~Region, z = ~ Cases, type = "heatmap",
               colors = "YlGnBu",zmin=0, zmax=350,
